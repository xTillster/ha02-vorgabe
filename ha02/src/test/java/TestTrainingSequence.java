...
public class TestTrainingSequence {
    ...
    private void testSequenceStrict(List<GymMetrics.AthleteAction> athleteActions, int offset) {
        assertEquals(GymMetrics.ActionType.STRETCH, athleteActions.get(offset).actionType);
        assertEquals(GymMetrics.ActionType.PICK_UP_SUCCESS, athleteActions.get(offset + 1).actionType);
        assertEquals(GymMetrics.ActionType.PICK_UP_SUCCESS, athleteActions.get(offset + 2).actionType);
        assertEquals(GymMetrics.ActionType.EXERCISE, athleteActions.get(offset + 3).actionType);
        assertEquals(GymMetrics.ActionType.PUT_DOWN_SUCCESS, athleteActions.get(offset + 4).actionType);
        assertEquals(GymMetrics.ActionType.PUT_DOWN_SUCCESS, athleteActions.get(offset + 5).actionType);
